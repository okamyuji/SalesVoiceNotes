...
final class SalesVoiceNotesUITests: XCTestCase {
    ...
    @MainActor
    func testStatusLabelExists() throws {
    ...
    @MainActor
    func testRecordStartButtonExists() throws {
        // 録音開始ボタンが存在することを確認
    ...
    @MainActor
    func testRecordStopButtonExists() throws {
        // 録音停止ボタンが存在することを確認
    ...
    @MainActor
    func testTranscriptionButtonExists() throws {
        // 文字起こしボタンが存在することを確認
    ...
    @MainActor
    func testEmptyResultMessageExists() throws {
    ...
    @MainActor
    func testRecordStartButtonIsEnabledInitially() throws {
    ...
    @MainActor
    func testRecordStopButtonIsDisabledInitially() throws {
    ...
    @MainActor
    func testTranscriptionButtonIsDisabledInitially() throws {
    ...
    @MainActor
    func testStatusSectionLayout() throws {
        // ステータスセクションのレイアウトを確認
        let statusLabel = app.staticTexts["状態"]
    ...
    @MainActor
    func testButtonsAreHorizontallyAligned() throws {
    ...
    @MainActor
    func testMainViewIsDisplayed() throws {
        // メインビューが表示されていることを確認
        let navBar = app.navigationBars["SalesVoiceNotes"]
        let statusLabel = app.staticTexts["状態"]
    ...
    @MainActor
    func testTapRecordButtonShowsPermissionOrChangesState() throws {
    ...
    @MainActor
    func testResultListIsScrollable() throws {
    ...
    @MainActor
    func testUIElementsExistAfterRotation() throws {
